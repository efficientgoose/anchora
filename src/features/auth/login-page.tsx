      ...
      <section className="flex items-center justify-center px-6 py-12 sm:p-8">
        <div className="w-full max-w-[380px] page-enter">
          ...
          <form className="mt-6" onSubmit={submit}>
            ...
            <label className="block"><span className="mb-2 flex items-center justify-between text-[13px] font-medium text-slate-700">Password <button type="button" className="font-normal text-indigo-600 hover:text-indigo-700">Forgot?</button></span><Input type="password" placeholder="••••••••" required autoComplete="current-password" /></label>
          ...
          <div className="mt-5 text-center text-[13px] text-slate-400">New to Anchora? <button className="font-medium text-indigo-600">Request access</button></div>
        </div>
      </section>
      <section className="relative hidden overflow-hidden bg-slate-950 p-14 text-slate-200 lg:flex lg:flex-col lg:justify-center">
        ...
        <div className="relative z-10 max-w-[410px] page-enter [animation-delay:100ms]">
          <div className="mb-[18px] text-sm font-semibold text-indigo-300">“We haven&apos;t missed a Uni-Assist deadline since.”</div>
          ...
          <div className="mt-6 flex items-center gap-3"><span className="flex size-10 items-center justify-center rounded-full bg-indigo-600 text-sm font-semibold text-white">PN</span><div><div className="text-sm font-semibold text-white">Priya Nair</div><div className="text-[13px] text-slate-400">Senior Consultant, Berlin</div></div></div>
        </div>
      </section>
    </main>
  );
